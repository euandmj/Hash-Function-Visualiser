...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.workingWordText = QtWidgets.QTextEdit(self.widget)
        self.workingWordText.setGeometry(QtCore.QRect(90, 40, 681, 51))
        self.workingWordText.setReadOnly(True)
        self.workingWordText.setObjectName("workingWordText")
        self.loopCountLabel_2 = QtWidgets.QLabel(self.widget)
        self.loopCountLabel_2.setGeometry(QtCore.QRect(90, 20, 201, 16))
